...
function Cardfive() {
  return (
    ...
    <hr/>
        ...
        <div class="container" style={{ marginTop: "90px",padding:'40px',backgroundImage:' linear-gradient(to right,#06beb6 ,#48b1bf)'}} id="logistics">
        <motion.div
            initial={{ x: "-100vw" }}
            animate={{ x: 0 }}
          ...
          >
              ...
              options={{
                strings: ["Logistics and Operations"],
                autoStart: true,
                loop: true,
              }}
            /></h1>
